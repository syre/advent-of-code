...
func advance_beams_part_one(beams_arr []coord, tachyon_diagram [][]string) (bool, int, []coord, [][]string) {
	new_beams_arr := []coord{}
	finished := false
	beams_split := 0
...
func advance_beams_part_two(beams_arr []coord, tachyon_diagram [][]string) (bool, int, []coord, [][]string) {
	new_beams_arr := []coord{}
	finished := false
	beams_split := 0
	for _, beam := range beams_arr {
...
func part_one() {
	...
	beams_split := 0
	for finished != true {
		finished, beams_split, beams_arr, tachyon_diagram = advance_beams_part_one(beams_arr, tachyon_diagram)
...
func part_two() {
	...
	beams_split := 0
	for finished != true {
		finished, beams_split, beams_arr, tachyon_diagram = advance_beams_part_two(beams_arr, tachyon_diagram)
		beams_split_sum *= beams_split
		//print_2d_array(tachyon_diagram)
	}
	fmt.Println(beams_split_sum)
